...
def main():
    # Initialize WandB
    experiment_name = "mini_experiment_5_ens_members"
    wandb.init(project="sea-ice-prediction", name=experiment_name, 
               notes="This experiment trains on only the first 5 (indexed) ensemble members to save time")
