...
python -m src.utils.bootstrap --metric acc --config_a exp1_input2 --config_b exp1_input3a --transform none
python -m src.utils.bootstrap --metric acc --config_a exp1_input2 --config_b exp1_input3b --transform none
python -m src.utils.bootstrap --metric acc --config_a exp1_input2 --config_b exp1_input3c --transform none
python -m src.utils.bootstrap --metric acc --config_a exp1_input2 --config_b exp1_input3d --transform none
python -m src.utils.bootstrap --metric acc --config_a exp1_input2 --config_b exp1_input4 --transform none
