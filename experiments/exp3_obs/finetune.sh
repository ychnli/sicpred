...
python3 -m src.models.diagnostics --config src/experiment_configs/exp3_obs/obs_input2.py --overwrite --ensemble-mean
...
python3 -m src.models.diagnostics --config src/experiment_configs/exp3_obs/obs_input2.py --predictions-path /scratch/users/yucli/sicpred_model_predictions/obs_input2_ensemble/exp2_vol4_UNetRes3_zeroshot_predictions.nc --label _cesm_zs