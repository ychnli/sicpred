...
################################ description ################################
EXPERIMENT_NAME = "exp2_vol2_dt"
NOTES = "Inputs: same as input2. Data volume: 4 ens members. Detrended data"
DATE = "" # optional 
...
DATA_CONFIG_NAME = "seaice_plus_auxiliary_vol2_dt"
...
DATA_SPLIT_SETTINGS = {
    ...
    "train": avail_ens_members[0:4], 
    "val": avail_ens_members[83:85],
    "test": avail_ens_members[85:90],
...
############################# evaluation configs #############################
CHECKPOINT_TO_EVALUATE = "epoch_14"
