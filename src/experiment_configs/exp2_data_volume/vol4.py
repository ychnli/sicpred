...
################################ description ################################
EXPERIMENT_NAME = "exp2_vol4_dt"
NOTES = "Inputs: same as input2. Data volume: 64 ens members. Detrended data"
DATE = "" # optional 
...
DATA_CONFIG_NAME = "seaice_plus_auxiliary_vol4_dt"
