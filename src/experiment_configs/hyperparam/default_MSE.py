...
################################ description ################################
EXPERIMENT_NAME = "hyperparam_default-MSE"
NOTES = "Instead of using the monthly- and area-weighted MSE, use only area-weighted MSE"
DATE = "" # optional 
...
DATA_CONFIG_NAME = "seaice_plus_auxiliary"
