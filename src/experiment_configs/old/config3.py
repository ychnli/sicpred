...
################################ description ################################
EXPERIMENT_NAME = "icefrac-only_small-dataset_predict-anom"
NOTES = "Only input variable is icefrac from last 12 months"
DATE = "" # optional 
...
DATA_CONFIG_NAME = "icefrac-only_small-dataset"
