"""
Configuration file for exp1_input3a_dev. Identical to input3a, except SST is normalized
by subtracting the mean only, with no divison by standard deviation.
"""
...
################################ description ################################
EXPERIMENT_NAME = "exp1_input3a_dev"
...
DATA_CONFIG_NAME = "seaice_plus_temp_dev"
