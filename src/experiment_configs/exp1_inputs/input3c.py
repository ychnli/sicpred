...
################################ description ################################
EXPERIMENT_NAME = "exp1_input3c"
NOTES = "Previous 12 months of sea ice + land mask and sin() and cos() of month + 6 months of z500"
DATE = "" # optional 
...
DATA_CONFIG_NAME = "seaice_plus_z500_minmax"
