...
Data and model artifacts produced from training are saved to paths set in `src/config_cesm.py`.
...
Unless specified, assume that you are developing on the Stanford Sherlock cluster. Here are important things to keep in mind about this machine:
